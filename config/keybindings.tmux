...
set -g status-left '#[bg=colour247]#[fg=colour23]#{?client_prefix,#[bg=colour24]#[fg=colour249],} ♂ #S #[bg=default]#[fg=colour247]#{?client_prefix,#[fg=colour24],}#{?window_zoomed_flag, ,}#[fg=colour1]#[bg=default] ♥ #(~/dotfiles/tmux_scripts/battery.sh)'
